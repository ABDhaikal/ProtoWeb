...
export const AboutMeCard : React.FC<RotatingCardProps> = ({ content, rotate }) => {
   return (
         <div className={`w-[100%] md:w-[45%] h-[100%] p-[1%] origin-top-left  bg-white rounded-sm shadow-[11.465076446533203px_11.465076446533203px_0px_0px_rgba(191,191,180,1.00)] border-4 border-black flex-col justify-start items-start  inline-flex `} style={{ transform: `rotate(${rotate}deg)` }}>
